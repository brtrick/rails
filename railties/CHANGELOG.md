*   When generating or updating a Rails app, report to the user if a component
    is not installed because an underlying dependency is skipped. Checks the
    following component/dependency pairs:
